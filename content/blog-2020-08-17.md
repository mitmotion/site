...
- The map generation code was made generic to allow using it outside of the
  ...
  more details.
- On world creation, we now compute *horizon maps*. See the function in
  ...
  the height map using only the *horizon angle* (the angle at which the sun
  ...
  store the *height* of the furthest occluder, to try to make the shadows
